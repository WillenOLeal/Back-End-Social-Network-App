...
export class AuthResolver {
  ...
  @Mutation(() => User)
  async register(@Arg("userInput", () => UserInput) userInput: UserInput) {
    ...
    if (user)
      throw new UserInputError("This email or username is alreay taken");
  ...
  async login(
    ...
    if (!isValid)
      throw new AuthenticationError(
        "Authenctication failed. Invalid credentials"
      );
